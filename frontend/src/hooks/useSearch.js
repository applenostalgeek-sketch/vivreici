...
const SS_KEYS = ['equipements', 'securite', 'immobilier', 'education', 'sante', 'transports', 'environnement', 'risques']
...
// Format : [[code_insee, [eq,sec,imm,edu,san,tra,env,ris], prix_m2], ...]
