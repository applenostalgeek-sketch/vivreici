...
const CATEGORIES = [
  ...
  { icon: '🌿', nom: 'Environnement', poids: 7, detail: 'Composite 50 % artificialisation des sols (taux d\'espaces naturels non artificialisés, CEREMA) + 50 % qualité de l\'air (indice ATMO moyen annuel sur 12 mois glissants). Communes sans données qualité de l\'air (37 %, surtout rurales) : score basé sur l\'artificialisation seule.', src: 'CEREMA 2023 · Atmo France' },
  { icon: '⚠️', nom: 'Risques naturels', poids: 4, detail: 'Plans de Prévention des Risques (PPR) approuvés — score inversé (moins de risques = mieux). Composite : inondation (35 %), séisme (30 %), mouvement de terrain (20 %), feux de forêt (10 %), avalanche (5 %). L\'absence de PPR ne signifie pas l\'absence de risque.', src: 'GASPAR Géorisques' },
]
...
const LIMITES = [
  ...
  { titre: 'Petites communes', txt: 'Les communes rurales ont souvent moins de données disponibles. Le score repose alors sur 3 à 5 catégories au lieu de 8.' },
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <section className="bg-white border border-border rounded-2xl p-6 mb-4">
          ...
          <p className="text-sm text-ink-light leading-relaxed mt-3">
            Les quartiers sont scorés sur les <strong className="text-ink">8 mêmes catégories</strong> que les communes.
            ...
            Les cinq autres (sécurité, transports, éducation, environnement, risques naturels)
